...
impl BoxModel {
    pub const ZERO: Self = Self {
        content_box: geo::Rect {
            x: 0.0,
            y: 0.0,
            width: 0.0,
            height: 0.0,
        },
        padding_box: geo::Rect {
            x: 0.0,
            y: 0.0,
            width: 0.0,
            height: 0.0,
    ...
    pub fn new(border_box: geo::Rect, padding: Edges, border: Edges, margin: Edges) -> Self {
...
impl std::fmt::Debug for BoxModel {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        f.debug_struct("BoxModel")
            .field(
                "margin_box",
                &format_args!("[{}, {}, {}, {}]", mb.x, mb.y, mb.width, mb.height),
            )
            .field(
                "border_box",
                &format_args!("[{}, {}, {}, {}]", bb.x, bb.y, bb.width, bb.height),
            )
            .field(
                "padding_box",
                &format_args!("[{}, {}, {}, {}]", pb.x, pb.y, pb.width, pb.height),
            )
            .field(
                "content_box",
                &format_args!("[{}, {}, {}, {}]", cb.x, cb.y, cb.width, cb.height),
            )
            .field(
                "padding",
                &format_args!(
