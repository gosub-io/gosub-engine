...
/// # use gosub_net::net::types::NetError;
/// # use gosub_net::net::observer::NetObserver;
/// # use gosub_net::net::events::NetEvent;
/// # use gosub_net::types::PeekBuf;
/// # struct Obs; impl NetObserver for Obs {
/// #   fn on_event(&self, _e: NetEvent) {}
/// # }
/// # async fn get_reader() -> impl AsyncRead + Unpin + Send + 'static { tokio::io::empty() }
/// use gosub_net::net::pump::{spawn_pump, PumpCfg, PumpTargets};
///
...
///     file_dest: None,
///     peek_buf: PeekBuf::from_slice(b"HTTP-HEAD"),
/// };
///
