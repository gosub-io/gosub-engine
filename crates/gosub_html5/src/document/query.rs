...
impl<C: HasDocument> DocumentQuery<C> {
    ...
    pub fn query(doc_handle: DocumentHandle<C>, query: &Query) -> gosub_shared::types::Result<Vec<NodeId>> {
    ...
    pub fn contains_child_tag(doc_handle: DocumentHandle<C>, node_id: NodeId, tag: &str) -> bool {
