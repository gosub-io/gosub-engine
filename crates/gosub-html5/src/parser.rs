...
use crate::parser::document::{Document, DocumentBuilder, DocumentFragment, DocumentType};
...
mod test {
    use super::*;
    use crate::gosub_shared::Encoding;
