...
use crate::{Brush, Transform, CairoBackend, Scene};
...
impl Border {
    ...
    fn draw_side(_scene: &mut Scene, opts: BorderRenderSideOptions) {
        ...
        // scene.stroke(
        //     &stroke,
        //     opts.transform.unwrap_or(&Transform::identity()),
        //     brush,
        //     None,
        //     &path,
        // );
...
impl TBorder<CairoBackend> for Border {
...
impl TBorderSide<CairoBackend> for BorderSide {
