...
mod tests {
    ...
    fn decodes_png_with_bad_chunk_crc() {
        ...
        const BAD_CRC_PNG: &[u8] = &[
            ...
            0x02, 0x00, 0x00, 0x00, 0x0b, 0x49, 0x44, 0x41, 0x54, 0x78, 0xda, 0x63, 0xfc, 0xcf, 0xc0, 0x50,
        ...
        let media = registry.decode(Some("image/png"), BAD_CRC_PNG).expect("lenient png decode");
        let img = expect_raster(media);
