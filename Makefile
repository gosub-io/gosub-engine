...
.PHONY: all test bench build fix doc clean test-unit test-clippy test-fmt test-check test-smoke fuzz-html5 fuzz-html5-tokenizer test-deny ci-check fuzz-css3 fuzz-svg-limits help examples wpt wpt-css wpt-css-parsing wpt-shortlist wpt-update
