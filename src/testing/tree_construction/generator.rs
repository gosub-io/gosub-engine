use html5::html5::node::{Node, NodeData, NodeTrait, NodeType, HTML_NAMESPACE};
use html5::html5::node::{MATHML_NAMESPACE, SVG_NAMESPACE, XLINK_NAMESPACE, XMLNS_NAMESPACE};
use html5::html5::parser::document::DocumentHandle;
